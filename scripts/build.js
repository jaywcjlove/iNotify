...
async function build() {
  ...
  write('dist/notify.js', umd.code)
    .then(() => write('dist/notify.min.js', umdMinified, true))
    .then(() => write('dist/notify.common.js', common.code))
    .then(() => write('dist/notify.common.min.js', commonMinified, true))
    .then(() => write('dist/notify.esm.js', es.code));
}
