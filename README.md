...
> ⚠️ 请使用 [iNotify 2.x](https://www.npmjs.com/package/@wcjiang/notify)，不再支持 [1.x](https://www.npmjs.com/package/title-notify) 版本 。
...
![界面预览](https://github.com/jaywcjlove/iNotify/blob/1.x/iNotify.png?raw=true)
